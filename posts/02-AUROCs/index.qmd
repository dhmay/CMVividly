...
date: "2026-07-24"
description: "Investigate the CMV diagnostic signal in HLA-COclusters."
format:
    html:
        toc: true
...
Class II-associated HLA-COclusters tend to be larger than Class I. So, that's a
*plausible* explanation for the HLA class difference in AUROC.

Perhaps some of those small HLA-COclusters are of low quality, i.e., not very CMV-specific. 
Or perhaps they're high-quality but suffer from a lot of dropout, i.e., in many CMV+
