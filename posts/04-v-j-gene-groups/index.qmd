...
To facilitate that kind of matching, I made a [library routine](https://github.com/dhmay/CMVividly/blob/main/src/python/cmvividly/data/combine_v_j_groups.py{target="_blank" rel="noopener noreferrer"}),
